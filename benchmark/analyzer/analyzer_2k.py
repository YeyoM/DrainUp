...
def main():
    ...
    csv_files = {
        'Drain': '../../result/Drain_2k_complex=0_frequent=0.csv',
        'UniParser': '../../result/UniParser_2k_complex=0_frequent=0.csv',
        'DrainUP': '../../result/DrainUP_2k_complex=0_frequent=0.csv',
    }
    
    time_files = {
        'Drain': '../../result/result_Drain_2k/parsing_times.json',
        'UniParser': '../../result/result_UniParser_2k/infer_time_2k.txt',
        'DrainUP': '../../result/result_DrainUP_2k/parsing_times.json',
    }
