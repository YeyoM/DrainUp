...
def main():
    ...
    csv_files = {
        'Drain': 'Drain_full_complex=0_frequent=0.csv',
        'UniParser': 'UniParser_full_complex=0_frequent=0.csv',
        'DrainUP': 'DrainUP_full_complex=0_frequent=0.csv',
    }
    
    time_files = {
        'Drain': 'result_Drain_full/parsing_times.json',
        'UniParser': 'result_UniParser_full/infer_time_full.txt',
        'DrainUP': 'result_DrainUp_full/parsing_times.json',
    }
