...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        print('\n=== Running evaluation for %s ===' % dataset)
    ...
    if args.drain_only is True:
        ...
        post_average(metric_file, f"DrainUP_{data_type}_complex={args.complex}_frequent={args.frequent}", args.complex, args.frequent)
    else: # DEFAULT
        post_average(metric_file, f"Drain_{data_type}_complex={args.complex}_frequent={args.frequent}", args.complex, args.frequent)
